...
// Must match the order as the native struct in zig files
...
typedef CreatePlaceNative = Pointer<Place> Function(Pointer<Place> place);
typedef CreatePlace = Pointer<Place> Function(Pointer<Place> place);
...
void main() {
  ...
  final place2 = createPlace(place);

  final name = place2.ref.name.toDartString();
